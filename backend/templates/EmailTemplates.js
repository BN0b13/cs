import { companyName, companyEmail, companySupportEmail, domainName } from "../config.js";
...
export default class EmailTemplates {
    ...
    passwordResetEmailTemplate = ({ token }) => {
        return {
            ...
            https://www.${domainName}/password-reset/${token}`,
            html: `
                <div style='text-align:center;'>
                    <h1>${companyName}</h1>
                    ...
                    <button style='border-radius:5px;'>
                        <a href='https://www.${domainName}/password-reset/${token}' style='text-decoration:none;border-radius:5px;padding:5px;'>
                            Reset Password
                        </a>
                    </button>
                </div>
    ...
    verifyEmailTemplate = ({ token }) => {
        return {
            ...
            https://www.${domainName}/verify-email/${token}`,
            html: `
                <div style='text-align:center;'>
                    <h1>${companyName}</h1>
                    ...
                    <button style='border-radius:5px;'>
                        <a href='https://www.${domainName}/verify-email/${token}' style='text-decoration:none;border-radius:5px;padding:5px;'>
                            Verify Email
                        </a>
                    </button>
            `
