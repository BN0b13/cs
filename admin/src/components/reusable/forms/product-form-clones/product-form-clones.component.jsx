...
const ProductFormClones = ({ product = null, category, productType, action, buttonName = 'Add Product' }) => {
            ...
            :
                <>
                    ...
                    <Select name='inventoryType' value={inventoryType} onChange={(e) => setInventoryType(e.target.value)}>
                        ...
                        <Option value={'regular'}>Rooted</Option>
                        <Option value={'feminized'}>Snips</Option>
                    </Select>

                    <Input type='text' value={sizeDescription} onChange={(e) => setSizeDescription(e.target.value)} placeholder='Size Description: 7 inch clone' />
...
export default ProductFormClones;