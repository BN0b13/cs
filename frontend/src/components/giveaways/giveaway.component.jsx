    ...
    return (
        <MainContainer>
            <ClientModal 
                ...
                message={`While we are excited to present ${giveaway.Company.name}'s giveaway to you, it's important to note that ${giveaway.Company.name} operates independently from Cosmic Strains. ${giveaway.Company.name} is solely responsible for managing this giveaway and distributing its prizes. By participating in this giveaway, you consent to sharing your username and email with ${giveaway.Company.name} and grant ${giveaway.Company.name} permission to contact you.`}
                action={() => submitEntry()} 
                actionText={'Enter'}
            />
            {giveaway.Company.id !== 1 &&
                <CompanyContainer>
                    <CompanyLogoContainer>
                        <Logo src={giveaway.Company.logoPath ? api + giveaway.Company.logoPath : (giveaway.Company.id !== 1 ? friendor : logo)} alt={giveaway.Company.name} />
                    </CompanyLogoContainer>
                    <CompanyDetailsContainer>
